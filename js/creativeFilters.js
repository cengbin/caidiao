        ...
        filters: [
            {
                ...
                name: '胶片时光',
                scene: '人像、街拍、旅行',
                description: '模拟柯达 Gold 200 胶片质感，暖色调带有轻微褪色感',
            ...
            },
            {
                ...
                name: '褪色记忆',
                scene: '人像、静物、日记风',
                description: '低对比褪色效果，仿佛隔了一层薄雾的旧照片',
            ...
            },
            {
                ...
                name: '颗粒电影',
                scene: '街拍、夜景、电影感画面',
                description: '高颗粒感的电影胶片风格，带有强烈的暗角和戏剧性',
            ...
            },
            {
                ...
                name: '光晕迷离',
                scene: '人像、婚礼、浪漫场景',
                description: '模拟老镜头的光晕和柔焦效果，画面温暖梦幻',
            ...
            },
            {
                ...
                name: '宝丽来',
                scene: '聚会、旅行、日常记录',
                description: '经典宝丽来即时成像风格，带有标志性的偏色',
            ...
            },
            {
                ...
                name: '褐色怀旧',
                scene: '老建筑、人像、历史感场景',
                description: '经典褐色调怀旧风格，仿佛19世纪的老照片',
            ...
            },
            {
                ...
                name: '日系清新',
                scene: '人像、风景、日常生活',
                description: '日系小清新风格，整体偏亮偏淡，带有淡淡的蓝绿色调',
            ...
            },
            {
                ...
                name: '复古霓虹',
                scene: '夜景、城市、人像',
                description: '80年代霓虹灯下的复古色调，粉紫与青色交织',
        ...
        filters: [
            {
                ...
                name: '双色交融',
                scene: '人像、海报、封面设计',
                description: '经典双色调效果，深紫与琥珀色形成强烈视觉冲击',
            ...
            },
            {
                ...
                name: '色调分离',
                scene: '风景、建筑、电影感画面',
                description: '高光暖黄与阴影冷蓝的色调分离，营造电影级色彩层次',
            ...
            },
            {
                ...
                name: '渐变映射',
                scene: '艺术创作、海报、概念设计',
                description: '将亮度映射到自定义渐变色阶，创造超现实的色彩过渡',
            ...
            },
            {
                key: 'color-invert',
                name: '色彩反转',
                scene: '艺术创作、实验摄影、创意设计',
                description: '完全反转色彩，创造出负片般的超现实视觉效果',
            ...
            },
            {
                ...
                name: '莫兰迪灰调',
                scene: '人像、静物、室内设计',
                description: '低饱和度的莫兰迪色系，高级灰调营造静谧优雅的氛围',
            ...
            },
            {
                ...
                name: '梵高星空',
                scene: '夜景、风景、艺术创作',
                description: '增强蓝黄对比，饱和浓郁，仿佛梵高笔下的星空世界',
            ...
            },
            {
                ...
                name: '红蓝电影',
                scene: '人像、电影、广告',
                description: '好莱坞经典调色方案，青橙对比突出主体，电影感十足',
        ...
        filters: [
            {
                ...
                name: '镜头光晕',
                scene: '风景、人像、户外',
                description: '模拟阳光直射镜头产生的光晕，增添自然真实的光线感',
            ...
            },
            {
                ...
                name: '体积光束',
                scene: '森林、教堂、室内',
                description: '模拟丁达尔效应的体积光，光线穿过缝隙形成可见光束',
            ...
            },
            {
                ...
                name: '霓虹都市',
                scene: '夜景、城市、人像',
                description: '赛博朋克风格的霓虹光效，粉蓝紫三色交织的城市夜景',
            ...
            },
            {
                ...
                name: '丁达尔森林',
                scene: '森林、公园、清晨',
                description: '模拟森林中阳光穿过树叶缝隙的丁达尔光柱效果',
            ...
            },
            {
                ...
                name: '烛光温暖',
                scene: '室内、人像、美食',
                description: '模拟烛光的温暖色调，中心明亮四周暗沉，温馨私密',
            ...
            },
            {
                ...
                name: '月光银辉',
                scene: '夜景、人像、静物',
                description: '冷调月光效果，银蓝色调营造宁静神秘的夜晚氛围',
            ...
            },
            {
                ...
                name: '逆光剪影',
                scene: '人像、风景、日落',
                description: '强烈的逆光效果，主体形成剪影，背景光晕灿烂',
        ...
        filters: [
            {
                ...
                name: '胶片颗粒',
                scene: '人像、街拍、电影感画面',
                description: '细腻的单色胶片颗粒，模拟真实胶片的质感和温度',
            ...
            },
            {
                ...
                name: '纸张纹理',
                scene: '人像、静物、复古风',
                description: '在画面上叠加真实纸张纹理，增添手工质感和温度',
            ...
            },
            {
                ...
                name: '故障艺术',
                scene: '创意设计、封面、海报',
                description: '数字故障风格，RGB通道偏移和扫描线营造电子迷幻感',
            ...
            },
            {
                ...
                name: '漏光效果',
                scene: '人像、旅行、日常',
                description: '模拟胶片相机漏光，橙红色光晕从边缘渗入画面',
            ...
            },
            {
                ...
                name: '水墨晕染',
                scene: '风景、艺术创作、中国风',
                description: '水墨画般的晕染效果，浓淡相宜，留白意境深远',
            ...
            },
            {
                key: 'digital-noise',
                name: '像素噪点',
                scene: '夜景、高ISO场景、艺术创作',
                description: '高ISO数码相机的彩色噪点效果，带有随机色偏',
        ...
        filters: [
            {
                ...
                name: '鱼眼世界',
                scene: '风景、建筑、创意人像',
                description: '鱼眼镜头的桶形畸变效果，视野极度扩展，边缘夸张变形',
            ...
            },
            {
                ...
                name: '漩涡扭曲',
                scene: '艺术创作、创意设计、抽象',
                description: '以画面中心为轴产生漩涡状扭曲，仿佛时空漩涡',
            ...
            },
            {
                ...
                name: '像素王国',
                scene: '游戏风、创意设计、社交媒体',
                description: '将画面像素化为复古游戏风格，色彩简化为有限色板',
            ...
            },
            {
                ...
                name: '万花筒',
                scene: '艺术创作、封面设计、抽象',
                description: '万花筒般的对称重复图案，将普通画面转化为迷幻对称艺术',
            ...
            },
            {
                ...
                name: '波浪涟漪',
                scene: '水面倒影、创意设计、艺术',
                description: '水面波纹般的扭曲效果，画面仿佛倒映在涟漪水面上',
            ...
            },
            {
                ...
                name: '棱镜折射',
                scene: '人像、创意设计、专辑封面',
                description: '模拟光线通过棱镜的折射和色散，产生彩虹般的分裂效果',
            ...
            },
            {
                ...
                name: '碎裂镜面',
                scene: '创意设计、海报、封面',
                description: '画面仿佛被打碎的镜面，每个碎片有不同的反射偏移',
        ...
        filters: [
            {
                ...
                name: '油画笔触',
                scene: '风景、人像、艺术创作',
                description: '厚重的油画笔触质感，色彩浓郁饱满，边缘柔和过渡',
            ...
            },
            {
                ...
                name: '水彩晕染',
                scene: '风景、花卉、插画',
                description: '轻盈透明的水彩画效果，色彩自然晕染，留白清新雅致',
            ...
            },
            {
                ...
                name: '炭笔素描',
                scene: '人像、建筑、艺术创作',
                description: '粗犷的炭笔素描风格，明暗对比强烈，笔触粗犷有力',
            ...
            },
            {
                ...
                name: '波普艺术',
                scene: '人像、海报、广告',
                description: '安迪·沃霍尔式的波普艺术风格，高饱和色彩和网点半调效果',
            ...
            },
            {
                ...
                name: '浮雕刻画',
                scene: '建筑、人像、艺术创作',
                description: '石雕般的浮雕效果，画面呈现立体的凹凸质感',
            ...
            },
            {
                ...
                name: '铅笔画',
                scene: '人像、建筑、日常',
                description: '细腻的铅笔画风格，线条清晰流畅，纸张纹理自然',
            ...
            },
            {
                ...
                name: '马赛克艺术',
                scene: '建筑、装饰、艺术创作',
                description: '彩色马赛克拼贴效果，每个色块独立鲜明，拼合成完整画面',
        ...
        filters: [
            {
                ...
                name: '梦境柔光',
                scene: '人像、婚礼、浪漫场景',
                description: '柔和梦幻的光效，画面笼罩在一层轻柔的光晕中',
            ...
            },
            {
                ...
                name: '赛博朋克',
                scene: '夜景、城市、科幻',
                description: '霓虹灯下的赛博朋克世界，粉蓝紫三色高饱和度渲染',
            ...
            },
            {
                ...
                name: '蒸汽波梦',
                scene: '创意设计、封面、社交媒体',
                description: '90年代蒸汽波美学，粉紫色调带有复古未来主义的迷幻感',
            ...
            },
            {
                ...
                name: '哥特暗黑',
                scene: '人像、建筑、暗黑风',
                description: '阴郁的哥特风格，低明度高对比，暗角浓重，冷调肃穆',
            ...
            },
            {
                ...
                name: '治愈暖阳',
                scene: '人像、日常、美食',
                description: '温暖治愈的阳光色调，柔和舒适，仿佛午后的慵懒时光',
            ...
            },
            {
                ...
                name: '冰川极光',
                scene: '风景、夜景、极地',
                description: '极光般的冷调色彩，蓝绿色交织，神秘而壮丽',
            ...
            },
            {
                ...
                name: '黄金时刻',
                scene: '人像、风景、日落',
                description: '日落黄金时刻的温暖光线，金色光辉笼罩一切，柔和而浪漫',
